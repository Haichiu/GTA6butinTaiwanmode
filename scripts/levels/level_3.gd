...
func _add_rules() -> void:
	...
	traffic([Vector3(-5.25, 0, -60.0), Vector3(-5.25, 0, 95.0)] as Array[Vector3], 11.0, 3.5, ns_go)
	traffic([Vector3(5.25, 0, 60.0), Vector3(5.25, 0, -120.0)] as Array[Vector3], 11.0, 5.0, ns_go, 1.5)
